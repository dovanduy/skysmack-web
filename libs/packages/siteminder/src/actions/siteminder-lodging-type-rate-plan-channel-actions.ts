...
import { SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_REDUX_KEY, SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_ADDITIONAL_PATHS } from '../constants/constants';
...
export class LodgingTypeRatePlanChannelsActions extends RecordActionsBase<SiteMinderLodgingTypeRatePlanChannelsAppState, Store<SiteMinderLodgingTypeRatePlanChannelsAppState>> {
    constructor(protected store: Store<SiteMinderLodgingTypeRatePlanChannelsAppState>) { super(store, SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_REDUX_KEY, SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_ADDITIONAL_PATHS); }
