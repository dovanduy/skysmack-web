...
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNELS_REDUCER_KEY = 'siteMinderLodgingTypeRatePlanChannels';
...
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNELS_REDUX_KEY = 'SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_'; // reducer prefix, action, epics, Requests
