...
export const SITE_MINDER_REDUCER_KEY = 'siteMinder';
export const SITE_MINDER_AREA_KEY = 'siteminder'; // validation, store, menu
export const SITE_MINDER_REDUX_KEY = 'SITE_MINDER_'; // reducer prefix, action, epics, Requests
...
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_REDUCER_KEY = 'siteMinderLodgingTypeRatePlanChannels';
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_AREA_KEY = 'site_minder_lodging_type_rate_plan_channels'; // validation, store, menu
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_REDUX_KEY = 'SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_'; // reducer prefix, action, epics, Requests
export const SITE_MINDER_LODGING_TYPE_RATE_PLAN_CHANNES_ADDITIONAL_PATHS = ['lodgingtype-rateplan-channels']; // actions, requests