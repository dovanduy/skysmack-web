...
import { TERMINAL_RECEIPTS_REDUCER_KEY } from '../../constants/constants';
...
export function terminalReceiptsReducer(state = new TerminalReceiptsState(), action: ReduxAction, prefix: string = TERMINAL_RECEIPTS_REDUCER_KEY): TerminalReceiptsState {
    state = sharedReducer(state, action, new TerminalReceiptsState(), TERMINAL_RECEIPTS_REDUCER_KEY);
