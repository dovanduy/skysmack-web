...
import { AccessPolicyRulesCreateComponent } from '../access-policy-rules/components/access-policy-rules-create/access-policy-rules-create.component';
import { AccessPolicyRulesEditComponent } from '../access-policy-rules/components/access-policy-rules-edit/access-policy-rules-edit.component';
