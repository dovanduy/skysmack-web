...
@Component({
  selector: 'ss-doorways-options-create',
  templateUrl: './doorways-options-create.component.html'
})
export class DoorwaysOptionsCreateComponent extends RecordFormComponent<DoorwaysOptionsAppState, DoorwayOption, number> implements OnInit {
