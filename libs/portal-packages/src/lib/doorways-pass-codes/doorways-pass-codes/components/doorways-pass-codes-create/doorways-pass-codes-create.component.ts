...
@Component({
  selector: 'ss-doorways-pass-codes-create',
  templateUrl: './doorways-pass-codes-create.component.html'
})
export class DoorwaysPassCodesCreateComponent extends RecordFormComponent<DoorwaysPassCodesAppState, DoorwayPassCode, DoorwayPassCodeKey> implements OnInit {
