...
@Component({
  selector: 'ss-lodgings-doorways-create',
  templateUrl: './lodgings-doorways-create.component.html'
})
export class LodgingsDoorwaysCreateComponent extends RecordFormComponent<LodgingsDoorwaysAppState, LodgingDoorway, LodgingDoorwayKey> implements OnInit {
