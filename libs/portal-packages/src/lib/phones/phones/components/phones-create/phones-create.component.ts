...
@Component({
  selector: 'ss-phones-create',
  templateUrl: './phones-create.component.html'
})
export class PhonesCreateComponent extends RecordFormComponent<PhonesAppState, Phone, number> implements OnInit {
