...
import { LodgingTypeRatePlan, SITE_MINDER_LODGING_TYPE_RATE_PLANS_AREA_KEY, SITE_MINDER_LODGING_TYPE_RATE_PLANS_ADDITIONAL_PATHS, LodgingTypeRatePlanKey } from '@skysmack/packages-siteminder';

import { NgSiteMinderLodgingTypeRatePlansValidation, NgSiteMinderRatePlansActions, NgSiteMinderRatePlansStore, NgSiteMinderChannelsActions, NgSiteMinderChannelsStore } from '@skysmack/ng-siteminder';
...
export class NgSiteMinderLodgingTypeRatePlansFieldsConfig extends FieldsConfig<LodgingTypeRatePlan, LodgingTypeRatePlanKey> {
    public validation = new NgSiteMinderLodgingTypeRatePlansValidation();
    ...
    constructor(
        ...
        super(fieldProviders, SITE_MINDER_LODGING_TYPE_RATE_PLANS_ADDITIONAL_PATHS);
    }

    protected getEntityFields(loadedPackage: LoadedPackage, entity?: LocalObject<LodgingTypeRatePlan, LodgingTypeRatePlanKey>): Field[] {
