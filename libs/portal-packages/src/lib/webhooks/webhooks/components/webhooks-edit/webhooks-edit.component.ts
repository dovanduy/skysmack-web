...
@Component({
  selector: 'ss-webhooks-edit',
  templateUrl: './webhooks-edit.component.html'
})
export class WebhooksEditComponent extends RecordFormComponent<WebhooksAppState, Webhook, number> implements OnInit {
  constructor(
