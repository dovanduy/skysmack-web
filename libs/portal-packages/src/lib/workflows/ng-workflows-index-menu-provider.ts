...
import { WorkflowsIndexComponent } from './workflows/components/workflows-index/workflows-index.component';

@Injectable({ providedIn: 'root' })
export class NgWorkflowsIndexMenuProvider implements MenuProvider {
    ...
    public getMenuAreas(packagePath: string, componentKey: string): Observable<MenuArea[]> {
        return getCombinedMenuEntries<MenuArea>(
            getMenuEntries<MenuArea>(
                ...
                WorkflowsTypeId,
                componentKey,
                WorkflowsIndexComponent.COMPONENT_KEY,
