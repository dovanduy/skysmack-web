...
import { LodgingReservationsRequests, LodgingReservation } from '@skysmack/packages-lodging-reservations-feature';
import { NgRecordRequests } from '@skysmack/ng-redux';

@Injectable({ providedIn: 'root' })
export class NgLodgingReservationsRequests extends NgRecordRequests<LodgingReservation, number> implements LodgingReservationsRequests {
    constructor(
