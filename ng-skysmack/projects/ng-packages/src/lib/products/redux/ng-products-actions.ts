...
import { ProductsAppState, Product, PRODUCTS_REDUX_KEY } from '@skysmack/packages-products';
import { LocalObject, StrIndex } from '@skysmack/framework';

@Injectable({ providedIn: 'root' })
export class NgProductsActions extends RecordActionsBase<ProductsAppState, NgRedux<ProductsAppState>> {
    constructor(protected store: NgRedux<ProductsAppState>) { super(store, PRODUCTS_REDUX_KEY, []); }
