...
import { AccessPolicyRulesValidation } from './ng-acess-policy-rules-validation';
...
export class NgAccessPolicyRulesFieldsConfig extends FieldsConfig<AccessPolicyRule, NgAccessPolicyRuleFormDependencies> {
