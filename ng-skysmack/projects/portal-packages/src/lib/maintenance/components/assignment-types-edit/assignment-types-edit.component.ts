...
export class AssignmentTypesEditComponent extends DocumentRecordFormComponent<AssignmentTypesAppState, AssignmentType, number, NgAssignmentTypeFormDependencies> implements OnInit {
