...
export const INVOICE_ITEMS_AREA_KEY = 'invoiceItems'; // validation, registerRedux, store, menu
...
export const INVOICE_PAYMENTS_AREA_KEY = 'invoicePayments'; // validation, registerRedux, store, menu
