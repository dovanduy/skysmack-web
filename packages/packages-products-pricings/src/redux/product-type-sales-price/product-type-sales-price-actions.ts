...
import { PRODUCTS_SALES_PRICE_REDUX_KEY, PRODUCTS_SALES_PRICE_ADDITIONAL_PATHS } from '../../constants';
...
export class ProductTypeSalesPriceActions extends RecordActionsBase<ProductTypeSalesPriceAppState, Store<ProductTypeSalesPriceAppState>> {
    ...
    constructor(protected store: Store<ProductTypeSalesPriceAppState>) { super(store, PRODUCTS_SALES_PRICE_REDUX_KEY, PRODUCTS_SALES_PRICE_ADDITIONAL_PATHS); }
