...
export function accessPolicyRulesReducer(state = new AccessPolicyRulesState(), action: ReduxAction, prefix: string = 'ACCESS_POLICY_RULES_'): AccessPolicyRulesState {
