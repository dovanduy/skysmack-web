...
import { FieldActionsBase } from '../actions/field-actions-base';
...
export function fieldReducersBase(state: FieldState, action: any, prefix: string = ''): FieldState {
    let newState = Object.assign({}, state);

    switch (action.type) {
        case prefix + FieldActionsBase.CANCEL_DYNAMIC_FIELD_ACTION: {
            return cancelFieldAction(newState, action);
        }
        case prefix + FieldActionsBase.FIELD_GET_PAGED: {
        ...
        case prefix + FieldActionsBase.FIELD_GET_PAGED_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_GET_PAGED_FAILURE: {
        ...
        case prefix + FieldActionsBase.FIELD_GET_SINGLE_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_GET_SINGLE_FAILURE: {
            const castedAction: ReduxAction<HttpErrorResponse> = action;
            if (!GlobalProperties.production) {
                console.log('Error. Error Action:', castedAction);
            }
        ...
        case prefix + FieldActionsBase.FIELD_GET_AVAILABLE_FIELDS_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_GET_AVAILABLE_FIELDS_FAILURE: {
            const castedAction: ReduxAction<HttpErrorResponse> = action;
            if (!GlobalProperties.production) {
                console.log('Error. Error Action:', castedAction);
            }
        ...
        case prefix + FieldActionsBase.FIELD_ADD: {
        ...
        case prefix + FieldActionsBase.FIELD_ADD_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_ADD_FAILURE: {
            setActionError(action, 'Add error: ');
            return newState;
        }
        case prefix + FieldActionsBase.FIELD_UPDATE_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_UPDATE_FAILURE: {
            setActionError(action, 'Update error: ');
            return newState;
        }
        case prefix + FieldActionsBase.FIELD_DELETE_SUCCESS: {
        ...
        case prefix + FieldActionsBase.FIELD_DELETE_FAILURE: {
