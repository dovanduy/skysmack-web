...
export class RSQLFilterBuilder implements RSQLFilter, RSQLColumn, RSQLCompleteExpression {
  ...
  private connector: RSQLConnectors = RSQLConnectors.And;
  ...
  clear(): void {
    ...
    this.columnName = '';
    this.connector = RSQLConnectors.And;
  }
  ...
  or(): RSQLFilter {
    this.connector = RSQLConnectors.Or;
    return this;
  }
  ...
  private addToList(filter: RSQLFilterExpression | RSQLFilterList): void {
    if (this.connector === RSQLConnectors.And) {
